...
Matrix needs multiple types of keepers to get involved. Matrix Core Team developped bots to help keepers achieve some of their operations.

## Arbitrage Keepers

Tokens issued by the protocol will be tradable on exchanges and therefore have a market price. The protocol relies on arbitrageurs which will have profitable opportunities whenever the market prices of the tokens deviate from peg.
...
##Keepers for [Hedging Agents](hedging-agents/)
...
Staking is the mechanism by which governance tokens are distributed to HAs, SLPs, and agTokens holders. It follows the parameters set by the governance and specified in the [Matrix tokenomics article](https://blog.Matrix.money/Matrix-protocol-tokenomics-29ea8b7bf001).
